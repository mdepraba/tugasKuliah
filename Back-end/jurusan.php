            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <form action="jurusan.php?kd_jurusan=<?= $kd_jurusan ?>" method="GET">
                            <input type="hidden" name="kd_jurusan" value="<?= $kd_jurusan ?>">
                            <input type="hidden" name="edit" value="true">
                            <button type="submit" name="editBtn">edit</button>
                        </form>
                    </td>
                    <td class="text-center">
                        <form action="src/proses_jurusan.php?kd_jurusan=<?= $kd_jurusan ?>" method="GET">
                            <input type="hidden" name="kd_jurusan" value="<?= $kd_jurusan ?>">
...
?>
    <div class="container mt-5">
        <form action="src/proses_jurusan.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-2 w-25">
                <label for="kd_jurusan" class="form-label">Kode Jurusan</label>
                <input type="text" class="form-control" id="kd_jurusan" name="kd_jurusan" value="<?= $kd_jurusan ?>">
            </div>
            <div class="mb-2 w-25">
                <label for="nama_jurusan" class="form-label">Nama Jurusan</label>
                <input type="text" class="form-control" id="nama_jurusan" name="nama_jurusan" value="<?= $nama_jurusan ?>">
            </div>
