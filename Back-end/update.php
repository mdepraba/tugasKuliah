<?php
    ...
    $nim = $_GET['nim'];
    $data = $mhs->getMhs($nim);
    $curJurusan = isset($_POST['jurusan']) ? $_POST['jurusan'] : null;
...
<!-- jurusan -->
            <div class="mb-3">
                ...
                <select class="form-select" id="jurusan" name="jurusan">
                    ...
                    ?>
                        <option <?= ($j['kd_jurusan'] == $curJurusan) ? 'selected' : '' ?> value="<?= $j['kd_jurusan'] ?>"><?= $j['nama_jurusan'] ?></option>
                    <?php endforeach ?>
                </select>
            </div>
<!-- gender -->        
...
<!-- foto -->
            ...
            <button type="submit" class="btn btn-primary btn-lg btn-outline-dark" name="submitUpdate" value="submit">Simpan</button>
        </form>
    </div>
</body>
</html>
